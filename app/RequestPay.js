...
import { Text, View, Platform, StyleSheet, ScrollView, Alert } from 'react-native';
...
import { MemorizedUserCardWithMoney, UserCardWithMoney } from '../components/UserCardWithMoney';
...
export const RequestPay = ({navigation, route}) => {
    ...
    const completedCount = members.filter(item => item.status === "COMPLETE").length;
    ...
    return(
        ...
        <View style={styles.container}>
          ...
          ></TitleContainer>
          <View>
            <Text>{members.length}중 {completedCount}명 완료</Text>
          </View>
        ...
        <View style={styles.friends}>
            ...
            <View style={styles.memberTotalAmount}>
                <Text >{"총합: "} {memberAmountSum} {"원"}</Text>
            </View>
        </View>
...
const showConfirmation = () => {
    ...
    showAlert('가격 분배 오류!', '가격의 총 합이 점주가 요청한 금액과 일치하지 않습니다.', buttons, {cancelable: false});
  };
